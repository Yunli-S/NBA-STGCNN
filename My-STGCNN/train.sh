...
CUDA_VISIBLE_DEVICES=0 python3 train.py --lr 0.01 --n_stgcnn 1 --n_txpcnn 5  --dataset match --tag social-stgcnn-eth --use_lrschd --num_epochs 250 && echo "match Launched." &
P0=$!
