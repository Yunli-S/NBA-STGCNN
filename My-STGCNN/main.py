...
parser.add_argument('--pred_seq_len', type=int, default=5)
parser.add_argument('--dataset', default='match',
                    help='eth,hotel,univ,zara1,zara2,match')
...
def train(epoch):
    ...
    batch_count = 0
    is_fst_loss = True
    print("[DEBUG]loader_train:",loader_train)
    # Dataset长度:50346=25173*2
    ...
    for cnt, batch in enumerate(loader_train):
        ...
        if batch_count % args.batch_size != 0 and cnt != turn_point:
            ...
            writer.add_scalar('train/loss',loss_batch / batch_count,cnt)
...
for epoch in range(args.num_epochs):
    ...
    print("constant_metrics:",constant_metrics)
    print('*' * 30)
